...
function start() {
	...
	TweenLite.from(".player_shooter", 1.2, { x: "+=85", y: "-=5", ease: Power2.easeOut });
	TweenLite.from(".player_defender", 1.8, { x: "-=80", y: "-=5", ease: Power3.easeOut });
	TweenLite.from(".puck", 1.8, { x: "-=80", y: "+=55", ease: Power3.easeOut });
