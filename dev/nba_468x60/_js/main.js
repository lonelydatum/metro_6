...
function start(){
	...
	TweenLite.from(".player_shooter", 1.4, {x:"+=12", y:"+=2", ease:Power2.easeOut})
	TweenLite.from(".player_defender", 1.4, {x:"-=12", ease:Power3.easeOut})
	...
	tl.from('.cta', .2, {opacity:0}, "+=.7")
	tl.to('.cta', .1, {opacity:0}, "+=2.5")
